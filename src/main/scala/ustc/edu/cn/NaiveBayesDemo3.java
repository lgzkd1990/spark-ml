...
public class NaiveBayesDemo3 {
    public static void main(String[] args) throws IOException {
        FileUtils.deleteDirectory(new File("C:\\Users\\lgzkd\\IdeaProjects\\Spark-ML\\src\\main\\resources\\myNaiveBayesModel3"));
        ...
        //保存和加载训练模型
        model.save(jsc.sc(), base + "myNaiveBayesModel3");
        NaiveBayesModel sameModel = NaiveBayesModel.load(jsc.sc(), base + "myNaiveBayesModel3");
        //对新的事件进行概率预测
